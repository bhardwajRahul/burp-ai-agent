...
- **Impact:** Resource exhaustion on very large inputs, because the header stage is unbudgeted; and a false-negative window for custom patterns at window boundaries. Neither is a new leak relative to the pre-Phase-21 code.
